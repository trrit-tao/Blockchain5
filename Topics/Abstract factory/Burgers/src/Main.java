...
class BurgerKingIngredientFactory implements BurgerIngredientFactory {
    ...
    @Override
    public Cheese createCheese() {return new BurgerKingCheese();}

    @Override
    public Cutlet createCutlet() {return new BurgerKingCutlet();}

    @Override
    public Sauce createSauce() {return new BurgerKingSauce();}
}
